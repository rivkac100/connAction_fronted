                ...
                <TableContainer component={Paper} sx={{ mb: 4, boxShadow: 3, borderRadius: 2 }}>
                  <Table sx={{ minWidth: 650 }} aria-label="טבלת הזמנות">
                    <TableHead sx={{ bgcolor: '#f5f5f5' }}>
                      <TableRow>
                        <TableCell align="center" sx={{ fontWeight: 'bold' }}>קוד הזמנה</TableCell>
                        {params.mid && <TableCell align="center" sx={{ fontWeight: 'bold' }}>לקוח</TableCell>}
                        <TableCell align="center" sx={{ fontWeight: 'bold' }}>מתווך/ת</TableCell>
                        <TableCell align="center" sx={{ fontWeight: 'bold' }}>פעילות</TableCell>
                        <TableCell align="center" sx={{ fontWeight: 'bold' }}>תאריך</TableCell>
                        <TableCell align="center" sx={{ fontWeight: 'bold' }}>שעה</TableCell>
                        <TableCell align="center" sx={{ fontWeight: 'bold' }}>משתתפים</TableCell>
                        <TableCell align="center" sx={{ fontWeight: 'bold' }}>תשלום</TableCell>
